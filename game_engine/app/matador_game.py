...
from src.backend.bræt import Bræt
...
def get_tile_screen_center(i):
    ...
    angle = i * 360 / n_felter + rotation_angle + 90
    mid_angle = angle + (360 / n_felter) / 2
...
def get_tile_world_pos(tile_index):
    ...
    angle = tile_index * 360 / n_felter + rotation_angle + 90 + (360 / n_felter) / 2
...
def draw_popup():
    ...
    print(f"Popup for tile {popup_tile + 1}: {name}")
